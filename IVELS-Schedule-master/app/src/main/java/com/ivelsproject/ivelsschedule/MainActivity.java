package com.ivelsproject.ivelsschedule;
...
import com.ivelsproject.ivelsschedule.fragment.NotificationFragment;
import com.ivelsproject.ivelsschedule.fragment.ScheduleFragment;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        drawer.addItem(new DrawerItem()
                        .setImage(ContextCompat.getDrawable(MainActivity.this, R.drawable.ic_event_note))
                        .setTextPrimary(getString(R.string.menu_schedule))
        ...
        drawer.addItem(new DrawerItem()
                        .setImage(ContextCompat.getDrawable(MainActivity.this, R.drawable.ic_notifications))
                        .setTextPrimary(getString(R.string.menu_notification))
                        .setOnItemClickListener(new DrawerItem.OnItemClickListener() {
                            @Override
                            public void onClick(DrawerItem item, long id, int position) {
                                fragmentMenu = position;
